...
\section{Changelog}
\begin{changelog}
  \change{2024-06-13}{Added new hook, \verb|preprocess_content()|, for modyfying of the raw HTML string}
  \change{}{Clenup of some unused code}
  \change{}{Added \verb|add_to_config()| function, for modyfying of the configuraton table.}
